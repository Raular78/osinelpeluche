...
const MAXIMOS_INTENTOS = 8, // Intentos máximos que tiene el jugador
    ...
    NOMBRE_IMAGEN_OCULTA = "images/question.png"; // La imagen que se muestra cuando la real está oculta
new Vue({
    el: "#app",
    data: () => ({
    ...
    methods: {
        mostrarCreditos() {
            Swal.fire({
                title: "Acerca de",
                html: `Creado por <a href="www.arjonawebdesing.com">Arjonawebdesing</a>
                
                <strong>Arjonawebdesing</strong>
                <br>
                Imagen de signo de interrogación: 
                <div>Icons made by  Roundicons<a href="https://www.flaticon.com/authors/roundicons" title="Roundicons">Roundicons</a> 
                    from  flaticom <a rel="nofollow" href="https://www.flaticon.com/" title="Flaticon">www.flaticon.com</a> 
                    is licensed by  creativecommmons
        ...
        indicarFracaso() {
            Swal.fire({
                    title: "Perdiste",
                    html: `
                <img class="img-fluid" src="images/perdiste.png" alt="Perdiste">
        ...
        indicarVictoria() {
            Swal.fire({
                    title: "¡Ganaste!",
                    html: `
                    <a href="index2.html"><img class="img-fluid" src="images/PULSA AQUÍ PARA ENTRAR.png" alt="Ganaste"></a>
                    <p class="h4"Ahora puedes Entrar</p>`, 
